...
ARCHIVE_RAW_DATA_PATH = os.path.join(TRAINING_DATA_PATH, os.getenv('ARCHIVE_RAW_DATA', 'archive_raw_data'))
...
LOCAL_TRAINING_DATA_PATH = os.path.join(DATA, TRAINING_DATA_PATH)
LOCAL_RAW_DATA_PATH = os.path.join(TRAINING_DATA_PATH, RAW_DATA_PATH)
LOCAL_CHUNKED_DATA_PATH = os.path.join(TRAINING_DATA_PATH, CHUNKED_DATA_PATH)
LOCAL_PROCESSED_DATA_PATH = os.path.join(TRAINING_DATA_PATH, PROCESSED_DATA_PATH)


for folder_path in [TEMP, DATA, MODELS, LOCAL_TRAINING_DATA_PATH, LOCAL_RAW_DATA_PATH, LOCAL_CHUNKED_DATA_PATH, LOCAL_PROCESSED_DATA_PATH]:
